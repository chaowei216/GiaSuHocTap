...
namespace Repository.Repository
{
    public class RequestRepository : IRequestRepository
    {
        ...
        public PagedList<Request> GetUserRequest(int userId, RequestParameters parameters)
        {
            ...
            return PagedList<Request>.ToPagedList(request.Include(p => p.Class).Include(p => p.Course).Include(p => p.RequestTimes).ThenInclude(p => p.TimeTable).ThenInclude(p => p.User), parameters.PageNumber, parameters.PageSize);
        }
